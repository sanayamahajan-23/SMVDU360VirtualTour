  ...
  return (
    <>
      ...
      <Sphere args={[radius, 64, 64]} scale={2} ref={globeRef}>
        ...
        <Hotspot lat={25.61} lon={70.2} radius={radius} label="Shivalik B" onClick={() => onHotspotClick("/images/mypanorma.jpeg")} />
        <Hotspot lat={10.61} lon={70.2} radius={radius} label="Shivalik A" onClick={() => onHotspotClick("/images/pano-shivalik-a.jpg")} />
        <Hotspot lat={0.61} lon={74.2} radius={radius} label="Grocery" onClick={() => onHotspotClick("/images/pano-grocery.jpg")} />
        ...
        <Hotspot lat={0.61} lon={38.2} radius={radius} label="Block A" onClick={() => onHotspotClick("/images/pano-block-a.jpg")} />
        ...
        <Hotspot lat={0.0} lon={14.2} radius={radius} label="Central Library" onClick={() => onHotspotClick("/images/pano-library.jpg")} />
